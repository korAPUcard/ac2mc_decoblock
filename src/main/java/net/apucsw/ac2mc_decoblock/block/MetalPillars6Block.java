...
public class MetalPillars6Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_6")
	public static final Block block = null;

	public MetalPillars6Block(Ac2mcDecoblockModElements instance) {
		super(instance, 10);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_6");
		}
