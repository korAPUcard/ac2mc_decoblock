...
public class StonePillars7Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_7")
	public static final Block block = null;

	public StonePillars7Block(Ac2mcDecoblockModElements instance) {
		super(instance, 27);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_7");
		}
