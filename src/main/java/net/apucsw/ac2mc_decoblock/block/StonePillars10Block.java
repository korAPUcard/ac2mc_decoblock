...
public class StonePillars10Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_10")
	public static final Block block = null;

	public StonePillars10Block(Ac2mcDecoblockModElements instance) {
		super(instance, 42);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_10");
		}
