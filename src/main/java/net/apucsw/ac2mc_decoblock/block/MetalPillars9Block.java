...
public class MetalPillars9Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_9")
	public static final Block block = null;

	public MetalPillars9Block(Ac2mcDecoblockModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_9");
		}
