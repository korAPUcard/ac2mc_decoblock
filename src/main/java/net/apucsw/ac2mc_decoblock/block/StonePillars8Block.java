...
public class StonePillars8Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_8")
	public static final Block block = null;

	public StonePillars8Block(Ac2mcDecoblockModElements instance) {
		super(instance, 28);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_8");
		}
