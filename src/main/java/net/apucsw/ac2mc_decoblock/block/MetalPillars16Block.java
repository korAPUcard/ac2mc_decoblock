...
public class MetalPillars16Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_16")
	public static final Block block = null;

	public MetalPillars16Block(Ac2mcDecoblockModElements instance) {
		super(instance, 20);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_16");
		}
