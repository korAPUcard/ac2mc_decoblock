...
public class MetalPillars13Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_13")
	public static final Block block = null;

	public MetalPillars13Block(Ac2mcDecoblockModElements instance) {
		super(instance, 17);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_13");
		}
