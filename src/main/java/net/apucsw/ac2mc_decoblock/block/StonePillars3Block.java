...
public class StonePillars3Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_3")
	public static final Block block = null;

	public StonePillars3Block(Ac2mcDecoblockModElements instance) {
		super(instance, 23);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_3");
		}
