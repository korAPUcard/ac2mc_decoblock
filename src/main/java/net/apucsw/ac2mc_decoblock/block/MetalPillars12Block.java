...
public class MetalPillars12Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_12")
	public static final Block block = null;

	public MetalPillars12Block(Ac2mcDecoblockModElements instance) {
		super(instance, 16);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_12");
		}
