...
public class StonePillars1Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_1")
	public static final Block block = null;

	public StonePillars1Block(Ac2mcDecoblockModElements instance) {
		super(instance, 21);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_1");
		}
