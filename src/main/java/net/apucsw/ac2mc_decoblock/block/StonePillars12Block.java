...
public class StonePillars12Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_12")
	public static final Block block = null;

	public StonePillars12Block(Ac2mcDecoblockModElements instance) {
		super(instance, 44);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_12");
		}
