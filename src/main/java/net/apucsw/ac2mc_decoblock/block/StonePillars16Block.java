...
public class StonePillars16Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_16")
	public static final Block block = null;

	public StonePillars16Block(Ac2mcDecoblockModElements instance) {
		super(instance, 48);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_16");
		}
