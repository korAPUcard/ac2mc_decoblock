...
public class MetalPillars11Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_11")
	public static final Block block = null;

	public MetalPillars11Block(Ac2mcDecoblockModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_11");
		}
