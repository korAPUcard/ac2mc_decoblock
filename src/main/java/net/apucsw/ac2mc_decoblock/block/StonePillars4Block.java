...
public class StonePillars4Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_4")
	public static final Block block = null;

	public StonePillars4Block(Ac2mcDecoblockModElements instance) {
		super(instance, 24);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_4");
		}
