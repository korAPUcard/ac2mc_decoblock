...
public class StonePillars13Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_13")
	public static final Block block = null;

	public StonePillars13Block(Ac2mcDecoblockModElements instance) {
		super(instance, 45);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_13");
		}
