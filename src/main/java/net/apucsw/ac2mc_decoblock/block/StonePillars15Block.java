...
public class StonePillars15Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_15")
	public static final Block block = null;

	public StonePillars15Block(Ac2mcDecoblockModElements instance) {
		super(instance, 47);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_15");
		}
