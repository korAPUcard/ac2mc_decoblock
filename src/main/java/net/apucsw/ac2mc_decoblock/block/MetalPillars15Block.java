...
public class MetalPillars15Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_15")
	public static final Block block = null;

	public MetalPillars15Block(Ac2mcDecoblockModElements instance) {
		super(instance, 19);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_15");
		}
