...
public class CutWhiteSandstoneBlock extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:cut_white_sandstone")
	public static final Block block = null;

	public CutWhiteSandstoneBlock(Ac2mcDecoblockModElements instance) {
		super(instance, 40);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cut_white_sandstone");
		}
