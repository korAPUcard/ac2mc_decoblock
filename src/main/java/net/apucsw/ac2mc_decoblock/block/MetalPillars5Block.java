...
public class MetalPillars5Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_5")
	public static final Block block = null;

	public MetalPillars5Block(Ac2mcDecoblockModElements instance) {
		super(instance, 9);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_5");
		}
