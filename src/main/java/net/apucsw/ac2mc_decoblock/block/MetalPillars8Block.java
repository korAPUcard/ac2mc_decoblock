...
public class MetalPillars8Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_8")
	public static final Block block = null;

	public MetalPillars8Block(Ac2mcDecoblockModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_8");
		}
