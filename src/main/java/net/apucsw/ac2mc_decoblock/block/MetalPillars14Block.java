...
public class MetalPillars14Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_14")
	public static final Block block = null;

	public MetalPillars14Block(Ac2mcDecoblockModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_14");
		}
