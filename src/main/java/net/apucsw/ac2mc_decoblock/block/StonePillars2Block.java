...
public class StonePillars2Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_2")
	public static final Block block = null;

	public StonePillars2Block(Ac2mcDecoblockModElements instance) {
		super(instance, 22);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_2");
		}
