...
public class MetalPillars7Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_7")
	public static final Block block = null;

	public MetalPillars7Block(Ac2mcDecoblockModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_7");
		}
