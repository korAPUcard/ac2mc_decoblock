...
public class MetalPillars10Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:metal_pillars_10")
	public static final Block block = null;

	public MetalPillars10Block(Ac2mcDecoblockModElements instance) {
		super(instance, 14);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("metal_pillars_10");
		}
