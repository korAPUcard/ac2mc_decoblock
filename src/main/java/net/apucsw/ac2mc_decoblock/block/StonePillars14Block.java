...
public class StonePillars14Block extends Ac2mcDecoblockModElements.ModElement {
	@ObjectHolder("ac2mc_decoblock:stone_pillars_14")
	public static final Block block = null;

	public StonePillars14Block(Ac2mcDecoblockModElements instance) {
		super(instance, 46);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("stone_pillars_14");
		}
