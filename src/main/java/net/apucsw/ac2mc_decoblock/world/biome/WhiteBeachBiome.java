...
package net.apucsw.ac2mc_decoblock.world.biome;
...
import net.apucsw.ac2mc_decoblock.block.WhiteSandBlock;
import net.apucsw.ac2mc_decoblock.block.StonePillars14Block;
...
public class WhiteBeachBiome extends Ac2mcDecoblockModElements.ModElement {
	public static Biome biome;

	public WhiteBeachBiome(Ac2mcDecoblockModElements instance) {
		super(instance, 66);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(12638463).setWaterColor(-12618012).setWaterFogColor(-12618012)
						.withSkyColor(7972607).withFoliageColor(-8934609).withGrassColor(-7226023)
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(WhiteSandBlock.block.getDefaultState(),
								StonePillars14Block.block.getDefaultState(), StonePillars14Block.block.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Blocks.DEAD_BUSH.getDefaultState()),
								new SimpleBlockStateProvider(Blocks.VOID_AIR.getDefaultState()),
								new BlobFoliagePlacer(FeatureSpread.func_242252_a(2), FeatureSpread.func_242252_a(0), 3),
								new StraightTrunkPlacer(1, 2, 0), new TwoLayerFeature(1, 0, 1)))
				...
				biome = new Biome.Builder().precipitation(Biome.RainType.RAIN).category(Biome.Category.BEACH).depth(0.1f).scale(0.2f).temperature(1f)
						.downfall(0.5f).setEffects(effects).withMobSpawnSettings(mobSpawnInfo.copy())
						.withGenerationSettings(biomeGenerationSettings.build()).build();
				event.getRegistry().register(biome.setRegistryName("ac2mc_decoblock:white_beach"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("white_beach_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("white_beach_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("white_beach_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
